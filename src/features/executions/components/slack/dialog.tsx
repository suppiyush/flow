...
const formSchema = z.object({
  ...
  content: z.string().min(1, "Messsage content is required").max(2000, "Message cannot exceed 2000 characters"),
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    The message to send. Use {"{{variables}}"} for simple values or {"{{json variable}}"} to stringify
                    objects
                  </FormDescription>
                  <FormMessage />
                </FormItem>
